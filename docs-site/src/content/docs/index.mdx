...
<div style="display: flex; gap: 12px; flex-wrap: wrap; margin-top: 8px;">
  <img src="/aimux/annotations.png" alt="Trace with annotations" width="380" style="border-radius: 6px; border: 1px solid var(--sl-color-hairline-light);" />
  <img src="/aimux/costs.png" alt="Cost tracking dashboard" width="380" style="border-radius: 6px; border: 1px solid var(--sl-color-hairline-light);" />
</div>
