---
title: aimux
description: Multi-frontend dashboard for AI coding agents — TUI, web, and remote OpenShell sandboxes. Discover, trace, annotate, and manage Claude, Codex, and Gemini sessions.
template: splash
hero:
